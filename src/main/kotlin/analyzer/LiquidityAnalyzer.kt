...
class LiquidityAnalyzerAdvanced {
    ...
    fun generateAdvancedReport(): String {
        val sb = StringBuilder()
        sb.append("Advanced Liquidity Analysis Report\n")
        sb.append("Dzień (1=Pon, 7=Niedz) | Godzina | Średni wolumen | Std wolumenu | Śr. zmiana ceny | Std zmiany ceny\n")
        for (day in 1..7) {
...
class LiquidityAnalyzer {
    ...
    fun generateReport(): String {
        ...
        sb.append("Dzień (1=Pon, 7=Niedz) | Godzina | Średni wolumen | Średnia zmiana ceny\n")
        for (day in 1..7) {
            val dayStats = stats[day]
            if (dayStats != null) {
                for (hour in 0..23) {
